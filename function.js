...
do{
    response = prompt ("Que tipo de cuenta queres hacer? (SUMA-RESTA-DIVISION-MULTIPLICACION");
    ...
    switch(response.toUpperCase()){
        ...
        default: alert("tenes que usar una de las cuatro opciones");
    }
}while(!correct);
...
do{
    num = prompt("Inicie el valor para la " + response + ": (escriba 'x' para finalizar)");
